# Generated by Powerlevel10k configuration wizard on 2023-04-29 at 23:33 PDT.
...
# lightest, angled separators, sharp heads, round tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|skupper|pluto'
